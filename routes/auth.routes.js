...
try {
    ...
    if (foundEmail !== null) {
      res.status(406).json({ errorMessage: "Email has been already registered in the website." });
       return;
    }
   ...
   if (foundUser !== null) {
     res.status(406).json({errorMessage: "Username has been already registered in the website."});
     return;
   } 
